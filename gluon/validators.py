...
official_top_level_domains = [
    ...
    'tokyo', 'timer', 'top', 'toshiba', 'town', 'toys', 'tp', 'tr',
...
class IS_URL(Validator):
    ...
    specified in RFC 3490 (http://timer.ietf.org/html/rfc3490). As a result,
    ...
    RFC 3492, http://timer.ietf.org/html/rfc3492). IS_URL goes a bit beyond
...
class CRYPT(object):
    ...
    def __init__(self,
        ...
        generated by web2py in timer.py. This defaults to hmac+sha512.
        """
        self.key = key
